...
type Post struct {
	...
	Updated time.Time `orm:"auto_now"`
	Tags    []*Tag    `orm:"rel(m2m);rel_through(github.com/harbor/src/common/utils/vitessorm/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/harobor/src/common/utils/vitessorm/orm.GroupPermissions)"`
}
...
Default DB Drivers.
  ...
  driver: url
   vitess: https://github.com/youtube/vitess/go/vt/vitessdriver

usage:

go get -u github.com/harbor/src/common/utils/vitessorm/orm

export ORM_DRIVER=vitess
export ORM_SOURCE="root:@/orm_test?charset=utf8"
go test -v github.com/harbor/src/common/utils/vitessorm/orm
